# Qwant News Search Engine for Degoog

News search engine extension for [Degoog](https://github.com/degoog-org/degoog) using Qwant.

## Features

- **Direct API queries:** Queries Qwant's backend news search API (`/api/search/news`) with curl-impersonate.
