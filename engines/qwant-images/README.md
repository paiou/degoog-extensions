# Qwant Images Search Engine for Degoog

Image search engine extension for [Degoog](https://github.com/degoog-org/degoog) using Qwant.

## Features

- **Direct API queries:** Queries Qwant's backend image search API (`/api/search/images`) with curl-impersonate.
