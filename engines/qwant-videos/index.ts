...
export const description =
  "Qwant videos search engine. Directly queries Qwant's videos search API. Note: Uses 'curl-impersonate' (default in Degoog) on residential IPs or an anti-bot browser transport to query without manual cookies."
