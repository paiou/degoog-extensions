# Qwant Search Engine for Degoog

Web search engine extension for [Degoog](https://github.com/degoog-org/degoog) using Qwant.

## Features

- **Direct API queries:** Queries Qwant's backend search API with curl-impersonate for maximum speed and anonymity.
